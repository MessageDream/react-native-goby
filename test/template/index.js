...
var GOBY_TEST_APP_NAME = React.createClass({
    ...
    onSyncError(error) {
        return this.setStateAndSendMessage("Sync error " + error + " received.", "SYNC_STATUS", [Goby.SyncStatus.UNKNOWN_ERROR]);
    },
    ...
    sendCurrentAndPendingPackage() {
        return Goby.getUpdateMetadata(Goby.UpdateState.PENDING)
            .then((pendingPackage) => {
                ...
                return Goby.getUpdateMetadata(Goby.UpdateState.RUNNING);
            })
            .then((currentPackage) => {
    ...
    sendTestMessage(message, args, callback) {
        function makeNetworkCall() {
            return new Promise(function(resolve, reject) {
                ...
                xhr.open("POST", "GOBY_SERVER_URL/reportTestMessage", true);
    ...
    render() {
        ...
        <View style={styles.container}>
            ...
            Goby React-Native Plugin Tests
            </Text>
...
AppRegistry.registerComponent('GOBY_TEST_APP_NAME', () => GOBY_TEST_APP_NAME);