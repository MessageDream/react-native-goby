...
@implementation GobyUpdateUtils

NSString * const AssetsFolderName = @"assets";
NSString * const BinaryHashKey = @"GobyBinaryHash";
NSString * const ManifestFolderPrefix = @"Goby";
                                 ...
                                 error:(NSError **)error
{
    ...
    NSString *assetsPath = [Goby bundleAssetsPath];
