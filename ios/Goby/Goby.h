...
@interface Goby : RCTEventEmitter
 ...
 * that was downloaded as part of a Goby update. The value returned
 ...
 * the Info.plist file's GobyDeploymentKey setting.
 */
...
@interface GobyDownloadHandler : NSObject <NSURLConnectionDelegate>
...
@interface GobyErrorUtils : NSObject

+ (NSError *)errorWithMessage:(NSString *)errorMessage;
+ (BOOL)isGobyError:(NSError *)error;

@end

@interface GobyPackage : NSObject
...
@interface GobyTelemetryManager : NSObject
...
@interface GobyUpdateUtils : NSObject
...
typedef NS_ENUM(NSInteger, GobyInstallMode) {
    GobyInstallModeImmediate,
    GobyInstallModeOnNextRestart,
    GobyInstallModeOnNextResume,
    GobyInstallModeOnNextSuspend
};

typedef NS_ENUM(NSInteger, GobyUpdateState) {
    GobyUpdateStateRunning,
    GobyUpdateStatePending,
    GobyUpdateStateLatest
};
