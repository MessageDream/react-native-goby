...
static NSString *const LastDeploymentReportKey = @"GOBY_LAST_DEPLOYMENT_REPORT";
...
static NSString *const RetryDeploymentReportKey = @"GOBY_RETRY_DEPLOYMENT_REPORT";
static NSString *const StatusKey = @"status";

@implementation GobyTelemetryManager
...
+ (NSDictionary *)getBinaryUpdateReport:(NSString *)appVersion
{
    ...
    if (previousStatusReportIdentifier == nil) {
        ...
        if ([self isStatusReportIdentifierGobyLabel:previousStatusReportIdentifier]) {
...
+ (BOOL)isStatusReportIdentifierGobyLabel:(NSString *)statusReportIdentifier
{
