declare module 'goby-plugin-testing-framework/script/platform' {
	import Q = require("q");
	/**
	 * Defines a platform supported by Goby.
	 */
...
declare module 'goby-plugin-testing-framework/script/projectManager' {
	import Q = require("q");
	import platform = require('goby-plugin-testing-framework/script/platform');
	/**
...
declare module 'goby-plugin-testing-framework/script/test' {
	import Platform = require('goby-plugin-testing-framework/script/platform');
	import { ProjectManager } from 'goby-plugin-testing-framework/script/projectManager';
	/**
...
declare module 'goby-plugin-testing-framework/script/serverUtil' {
	import platform = require('goby-plugin-testing-framework/script/platform');
	import Q = require("q");
	...
	/**
	 * Class used to mock the goby.checkForUpdate() response from the server.
	 */
	...
	/**
	 * The model class of the goby.checkForUpdate() request to the server.
	 */
...
declare module 'goby-plugin-testing-framework/script/testBuilder' {
	import Platform = require('goby-plugin-testing-framework/script/platform');
	import { ProjectManager } from 'goby-plugin-testing-framework/script/projectManager';
...
declare module 'goby-plugin-testing-framework/script/testConfig' {
...
declare module 'goby-plugin-testing-framework/script/testUtil' {
	import Q = require("q");
	export class TestUtil {
	    ...
	    static GOBY_APP_VERSION_PLACEHOLDER: string;
	    static GOBY_TEST_APP_NAME_PLACEHOLDER: string;
	    static GOBY_APP_ID_PLACEHOLDER: string;
...
declare module 'goby-plugin-testing-framework/script/index' {
	import * as Platform from 'goby-plugin-testing-framework/script/platform';
	import * as PluginTestingFramework from 'goby-plugin-testing-framework/script/test';
	import { ProjectManager, setupTestRunScenario, setupUpdateScenario } from 'goby-plugin-testing-framework/script/projectManager';
	import * as ServerUtil from 'goby-plugin-testing-framework/script/serverUtil';
	import { TestBuilder } from 'goby-plugin-testing-framework/script/testBuilder';
	import * as TestConfig from 'goby-plugin-testing-framework/script/testConfig';
	import { TestUtil } from 'goby-plugin-testing-framework/script/testUtil';
...
declare module 'goby-plugin-testing-framework' {
	import main = require('goby-plugin-testing-framework/script/index');
	export = main;
}
