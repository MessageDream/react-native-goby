...
var TestUtil = (function () {
    ...
    TestUtil.archiveFolder = function (sourceFolder, targetFolder, archivePath, isDiff) {
        ...
        if (isDiff) {
            archive.append("{\"deletedFiles\":[]}", { name: "hotgoby.json" });
        }
    ...
    TestUtil.ANDROID_KEY_PLACEHOLDER = "GOBY_ANDROID_DEPLOYMENT_KEY";
    TestUtil.IOS_KEY_PLACEHOLDER = "GOBY_IOS_DEPLOYMENT_KEY";
    TestUtil.SERVER_URL_PLACEHOLDER = "GOBY_SERVER_URL";
    TestUtil.INDEX_JS_PLACEHOLDER = "GOBY_INDEX_JS_PATH";
    TestUtil.GOBY_APP_VERSION_PLACEHOLDER = "GOBY_APP_VERSION";
    TestUtil.GOBY_TEST_APP_NAME_PLACEHOLDER = "GOBY_TEST_APP_NAME";
    TestUtil.GOBY_APP_ID_PLACEHOLDER = "GOBY_TEST_APPLICATION_ID";
    TestUtil.PLUGIN_VERSION_PLACEHOLDER = "GOBY_PLUGIN_VERSION";
    return TestUtil;
}());
