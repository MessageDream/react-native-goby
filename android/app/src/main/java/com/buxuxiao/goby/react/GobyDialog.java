...
public class GobyDialog extends ReactContextBaseJavaModule{

    public GobyDialog(ReactApplicationContext reactContext) {
        super(reactContext);
    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    ...
                    case DialogInterface.BUTTON_NEGATIVE:
                        ...
                        break;
                    default:
                        throw new GobyUnknownException("Unknown button ID pressed.");
                }
            }
        };
