...
public class GobyTelemetryManager {
    ...
    private final String LAST_DEPLOYMENT_REPORT_KEY = "GOBY_LAST_DEPLOYMENT_REPORT";
    ...
    private final String RETRY_DEPLOYMENT_REPORT_KEY = "GOBY_RETRY_DEPLOYMENT_REPORT";
    private final String STATUS_KEY = "status";

    public GobyTelemetryManager(Context applicationContext) {
    ...
    public WritableMap getBinaryUpdateReport(String appVersion) {
        ...
        if (previousStatusReportIdentifier == null) {
            ...
            this.clearRetryStatusReport();
            reportMap = Arguments.createMap();
            if (this.isStatusReportIdentifierGobyLabel(previousStatusReportIdentifier)) {
    ...
    public WritableMap getRetryStatusReport() {
        ...
        if (retryStatusReportString != null) {
            ...
            try {
                ...
                return GobyUtils.convertJsonObjectToWritable(retryStatusReport);
    ...
    public void saveStatusReportForRetry(ReadableMap statusReport) {
        JSONObject statusReportJSON = GobyUtils.convertReadableToJsonObject(statusReport);
    ...
    private String getPackageStatusReportIdentifier(ReadableMap updatePackage) {
        ...
        String deploymentKey = GobyUtils.tryGetString(updatePackage, DEPLOYMENT_KEY_KEY);
        String label = GobyUtils.tryGetString(updatePackage, LABEL_KEY);
    ...
    private boolean isStatusReportIdentifierGobyLabel(String statusReportIdentifier) {
