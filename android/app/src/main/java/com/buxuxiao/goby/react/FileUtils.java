...
public class FileUtils {
        ...
        for (File sourceFile : sourceDir.listFiles()) {
            if (sourceFile.isDirectory()) {
                copyDirectoryContents(
                        GobyUtils.appendPathComponent(sourceDirectoryPath, sourceFile.getName()),
                        GobyUtils.appendPathComponent(destinationDirectoryPath, sourceFile.getName()));
            } else {
    ...
    public static void deleteFileOrFolderSilently(File file) {
        ...
        if (!file.delete()) {
            GobyUtils.log("Error deleting file " + file.getName());
        }
    }
    ...
    public static void moveFile(File fileToMove, String newFolderPath, String newFileName) {
        ...
        if (!fileToMove.renameTo(newFilePath)) {
            throw new GobyUnknownException("Unable to move file from " +
